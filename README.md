...
<body>
  ...
  <div class="preview-box">
    ...
    <p style="color: #a855f7;">معاينة التصميم الحقيقي هنا</p>
  </div>

  <script>
    // ضع كود الجافاسكريبت هنا بين علامتي ` `
    const jsText = `const name = "ApexViperCode";
console.log("Welcome to " + name);`;

    // ضع كود الـ HTML هنا بين علامتي ` `
    const htmlText = `<div class="card">
    <h1>مرحباً بك</h1>
    <button>اضغط هنا</button>
</div>`;

    // ضع كود الـ CSS هنا بين علامتي ` `
    const cssText = `.card {
    ...
    // ربط الأكواد بالعناصر
    document.getElementById("js-code").textContent = jsText;
